...
Objetivo: El objetivo de esta actividad es que los estudiantes practiquen el análisis de flujo de datos en Java utilizando las clases vistas hasta ahora ( LineNumberReader, StreamTokenizer y PushbackReader, etc). En este ejercicio, analizarán un archivo de texto y contarán cuántas palabras y cuántos números hay en cada línea del archivo.
